...
var levelOne= ["eagle", "cuckoo", "bat", "peacock","pigeon","bee"];
var levelTwo = [ "banana", "apple", "papaya", "date", "melon", "mango","olive","strawberry"];
var levelThree= ["cabbage", "carrot", "radish", "cucumber", "capsicum", "peas", "mushroom", "tomato"];
var levelFour= ["pink", "white", "black", "yellow", "ged", "green", "blue", "brown"];
var levelFive=["saudi arabia", "qatar", "sweden", "america","pakistan", "nepal", "south africa", "norway", "somalia","dubai", "poland", "ran"];

// determine gameword
var index = prompt("Welcome to Hangman! Which level(1-5) would you like to play? (Hints)Level 1 is about Birds,Level 2 is about Fruits,Level3 is about Vagetables, Level 4 is about Colours,Level 5 is about Countries");        
...
// starts game 
function startGame() {
	var playerConfirmation = confirm("Do you really want to play?");
...
/*	draw and fill in blank array for word in gamespace	*/
...
function gameOver(status) {
	fillInWholeWord();
        ...
        if (playAgain === true) {
        	...
        	blankCanvas();  
            	document.getElementById("idResult").innerHTML=("Okay No worries, see you next time!");
        }
};
